...
vector<vector<int> > FindPath(TreeNode *root, int expectNumber){
	...
	TreeNode *cur = root; //当前节点   如果设置null。错误！！！！！！！！！//这个.....................................................
	TreeNode *last = NULL; //保存上一个节点//这个.....................................................//这个.....................................................
	while (!s.empty()){
		if (cur == NULL){
			TreeNode *temp = s.top();
			...
			else{//3.遇到叶子节点cur更新为NULL，此时看栈顶元素，如果栈顶元素的右子树为空或者右孩子已经访问过了，把栈顶元素保存在last变量中，同时弹出栈顶元素，当期路径中栈顶元素弹出，sum减掉栈顶元
				//这一步骤不更改cur的值；//这个.....................................................//这个.....................................................
				last = temp; //保存上一个已遍历的节点
				s.pop();
				curPath.pop_back(); //从当前路径删除//这个.....................................................
				sum -= temp->val;
			}
		}
		else{
